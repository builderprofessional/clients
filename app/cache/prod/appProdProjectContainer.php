...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=127.0.0.1;dbname=bptraining;charset=UTF8', 'user' => 'bptraining', 'password' => 'bptraining', 'classname' => 'PropelPDO', 'options' => array(), 'attributes' => array(), 'settings' => array())))));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('567f4c2a7951e7.72153469')), true);
