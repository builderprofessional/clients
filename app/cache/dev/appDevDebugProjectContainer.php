...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'engine.twig.citystatezip_extension' => 'getEngine_Twig_CitystatezipExtensionService',
            'engine.twig.currency_extension' => 'getEngine_Twig_CurrencyExtensionService',
            'engine.twig.labelvalue_extension' => 'getEngine_Twig_LabelvalueExtensionService',
            'engine.twig.pagebreak_extension' => 'getEngine_Twig_PagebreakExtensionService',
            'engine.twig.pdfelement_extension' => 'getEngine_Twig_PdfelementExtensionService',
            'engine.twig.rate_to_percentage_extension' => 'getEngine_Twig_RateToPercentageExtensionService',
            'engine.twig.withlinebreak_extension' => 'getEngine_Twig_WithlinebreakExtensionService',
    ...
    /**
     * Gets the 'engine.twig.citystatezip_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\DemographicBundle\Twig\Func\CityStateZip A Engine\DemographicBundle\Twig\Func\CityStateZip instance.
     */
    protected function getEngine_Twig_CitystatezipExtensionService()
    {
        return $this->services['engine.twig.citystatezip_extension'] = new \Engine\DemographicBundle\Twig\Func\CityStateZip();
    }

    /**
     * Gets the 'engine.twig.currency_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\BillingBundle\Twig\Filter\Currency A Engine\BillingBundle\Twig\Filter\Currency instance.
     */
    protected function getEngine_Twig_CurrencyExtensionService()
    {
        return $this->services['engine.twig.currency_extension'] = new \Engine\BillingBundle\Twig\Filter\Currency();
    }

    /**
     * Gets the 'engine.twig.labelvalue_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\ReportBundle\Twig\Func\LabelValue A Engine\ReportBundle\Twig\Func\LabelValue instance.
     */
    protected function getEngine_Twig_LabelvalueExtensionService()
    {
        return $this->services['engine.twig.labelvalue_extension'] = new \Engine\ReportBundle\Twig\Func\LabelValue();
    }

    /**
     * Gets the 'engine.twig.pagebreak_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\ReportBundle\Twig\Func\PageBreak A Engine\ReportBundle\Twig\Func\PageBreak instance.
     */
    protected function getEngine_Twig_PagebreakExtensionService()
    {
        return $this->services['engine.twig.pagebreak_extension'] = new \Engine\ReportBundle\Twig\Func\PageBreak();
    }

    /**
     * Gets the 'engine.twig.pdfelement_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\ReportBundle\Twig\Tag\PdfElement\Extension A Engine\ReportBundle\Twig\Tag\PdfElement\Extension instance.
     */
    protected function getEngine_Twig_PdfelementExtensionService()
    {
        return $this->services['engine.twig.pdfelement_extension'] = new \Engine\ReportBundle\Twig\Tag\PdfElement\Extension();
    }

    /**
     * Gets the 'engine.twig.rate_to_percentage_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\EngineBundle\Twig\Filter\RateToPercentage A Engine\EngineBundle\Twig\Filter\RateToPercentage instance.
     */
    protected function getEngine_Twig_RateToPercentageExtensionService()
    {
        return $this->services['engine.twig.rate_to_percentage_extension'] = new \Engine\EngineBundle\Twig\Filter\RateToPercentage();
    }

    /**
     * Gets the 'engine.twig.withlinebreak_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Engine\ReportBundle\Twig\Filter\WithLinebreak A Engine\ReportBundle\Twig\Filter\WithLinebreak instance.
     */
    protected function getEngine_Twig_WithlinebreakExtensionService()
    {
        return $this->services['engine.twig.withlinebreak_extension'] = new \Engine\ReportBundle\Twig\Filter\WithLinebreak();
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=127.0.0.1;dbname=bptraining;charset=UTF8', 'user' => 'bptraining', 'password' => 'bptraining', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array())))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('engine.twig.currency_extension'));
        $instance->addExtension($this->get('engine.twig.citystatezip_extension'));
        $instance->addExtension($this->get('engine.twig.rate_to_percentage_extension'));
        $instance->addExtension($this->get('engine.twig.withlinebreak_extension'));
        $instance->addExtension($this->get('engine.twig.labelvalue_extension'));
        $instance->addExtension($this->get('engine.twig.pagebreak_extension'));
        $instance->addExtension($this->get('engine.twig.pdfelement_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/third-engine/propelsoa/Resources/views'), 'PropelSOA');
        $instance->addPath(($this->targetDirs[3].'/src/Training/TrainingBundle/Resources/views'), 'TrainingTraining');
        $instance->addPath(($this->targetDirs[3].'/src/Engine/BillingBundle/Resources/views'), 'EngineBilling');
        $instance->addPath(($this->targetDirs[3].'/src/Engine/DemographicBundle/Resources/views'), 'EngineDemographic');
        $instance->addPath(($this->targetDirs[3].'/src/Engine/EngineBundle/Resources/views'), 'Engine');
        $instance->addPath(($this->targetDirs[3].'/src/Engine/MediaBundle/Resources/views'), 'EngineMedia');
        $instance->addPath(($this->targetDirs[3].'/src/Engine/ReportBundle/Resources/views'), 'EngineReport');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c03d264b3ce304b55653878ae3fa1c4be3edd0cc');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5686f279920a91.14354133')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PropelSOABundle' => 'ThirdEngine\\PropelSOABundle\\PropelSOABundle',
                'TrainingTrainingBundle' => 'Training\\TrainingBundle\\TrainingTrainingBundle',
                'EngineAuthBundle' => 'Engine\\AuthBundle\\EngineAuthBundle',
                'EngineBillingBundle' => 'Engine\\BillingBundle\\EngineBillingBundle',
                'EngineDemographicBundle' => 'Engine\\DemographicBundle\\EngineDemographicBundle',
                'EngineBundle' => 'Engine\\EngineBundle\\EngineBundle',
                'EngineMediaBundle' => 'Engine\\MediaBundle\\EngineMediaBundle',
                'EngineReportBundle' => 'Engine\\ReportBundle\\EngineReportBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'bptraining',
            'database_user' => 'bptraining',
            'database_password' => 'bptraining',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'c03d264b3ce304b55653878ae3fa1c4be3edd0cc',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c03d264b3ce304b55653878ae3fa1c4be3edd0cc',
