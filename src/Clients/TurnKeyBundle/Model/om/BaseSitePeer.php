...
use Clients\TurnKeyBundle\Model\map\SiteTableMap;
use Engine\BillingBundle\Model\ClientPeer;

abstract class BaseSitePeer extends \Engine\EngineBundle\Base\EnginePeer
{
    ...
    const TABLE_NAME = 'turnkey_site';

    /** the related Propel class for this table */
    const OM_CLASS = 'Clients\\TurnKeyBundle\\Model\\Site';
    ...
    const TURNKEY_SITE_ID = 'turnkey_site.turnkey_site_id';

    /** the column name for the date_modified field */
    const DATE_MODIFIED = 'turnkey_site.date_modified';

    /** the column name for the date_created field */
    const DATE_CREATED = 'turnkey_site.date_created';

    /** the column name for the billing_client_id field */
    const BILLING_CLIENT_ID = 'turnkey_site.billing_client_id';

    /** the column name for the code field */
    const CODE = 'turnkey_site.code';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('SiteId', 'DateModified', 'DateCreated', 'BillingClientId', 'Code', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('siteId', 'dateModified', 'dateCreated', 'billingClientId', 'code', ),
        BasePeer::TYPE_COLNAME => array (SitePeer::TURNKEY_SITE_ID, SitePeer::DATE_MODIFIED, SitePeer::DATE_CREATED, SitePeer::BILLING_CLIENT_ID, SitePeer::CODE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TURNKEY_SITE_ID', 'DATE_MODIFIED', 'DATE_CREATED', 'BILLING_CLIENT_ID', 'CODE', ),
        BasePeer::TYPE_FIELDNAME => array ('turnkey_site_id', 'date_modified', 'date_created', 'billing_client_id', 'code', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('SiteId' => 0, 'DateModified' => 1, 'DateCreated' => 2, 'BillingClientId' => 3, 'Code' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('siteId' => 0, 'dateModified' => 1, 'dateCreated' => 2, 'billingClientId' => 3, 'code' => 4, ),
        BasePeer::TYPE_COLNAME => array (SitePeer::TURNKEY_SITE_ID => 0, SitePeer::DATE_MODIFIED => 1, SitePeer::DATE_CREATED => 2, SitePeer::BILLING_CLIENT_ID => 3, SitePeer::CODE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TURNKEY_SITE_ID' => 0, 'DATE_MODIFIED' => 1, 'DATE_CREATED' => 2, 'BILLING_CLIENT_ID' => 3, 'CODE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('turnkey_site_id' => 0, 'date_modified' => 1, 'date_created' => 2, 'billing_client_id' => 3, 'code' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SitePeer::TURNKEY_SITE_ID);
            $criteria->addSelectColumn(SitePeer::DATE_MODIFIED);
            $criteria->addSelectColumn(SitePeer::DATE_CREATED);
            $criteria->addSelectColumn(SitePeer::BILLING_CLIENT_ID);
            $criteria->addSelectColumn(SitePeer::CODE);
        } else {
            $criteria->addSelectColumn($alias . '.turnkey_site_id');
            $criteria->addSelectColumn($alias . '.date_modified');
            $criteria->addSelectColumn($alias . '.date_created');
            $criteria->addSelectColumn($alias . '.billing_client_id');
    ...
    /**
     * Method to invalidate the instance pool of all tables related to turnkey_site
    ...
    public static function doCountJoinClient(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SitePeer::BILLING_CLIENT_ID, ClientPeer::BILLING_CLIENT_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Site objects pre-filled with their Client objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinClient(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SitePeer::addSelectColumns($criteria);
        $startcol = SitePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = SitePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = SitePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                SitePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Site) to $obj2 (Client)
                $obj2->addSite($obj1);
    ...
    /**
     * Selects a collection of Site objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SitePeer::addSelectColumns($criteria);
        $startcol2 = SitePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Site) to the collection in $obj2 (Client)
                $obj2->addSite($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SitePeer::TURNKEY_SITE_ID) && $criteria->keyContainsValue(SitePeer::TURNKEY_SITE_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SitePeer::TURNKEY_SITE_ID);
            $value = $criteria->remove(SitePeer::TURNKEY_SITE_ID);
            if ($value) {
                $selectCriteria->add(SitePeer::TURNKEY_SITE_ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the turnkey_site table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SitePeer::TURNKEY_SITE_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(SitePeer::DATABASE_NAME);
        $criteria->add(SitePeer::TURNKEY_SITE_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SitePeer::DATABASE_NAME);
            $criteria->add(SitePeer::TURNKEY_SITE_ID, $pks, Criteria::IN);
