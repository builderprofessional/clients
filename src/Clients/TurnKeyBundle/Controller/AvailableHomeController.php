<?php
/**
 * This controller will allow a service to pull available homes.
 *
...
/**
 * @route /turnkey/availableHome
 */
class AvailableHomeController extends ModelBasedController implements Collectionable
{
  /**
  ...
  public function setupClassInfo()
  {
    ...
    $this->classInfo->entity    = 'AvailableHome';
  }

  /**
   * This action will return a list of available homes.
   *
   * @route /public/turnkey/availableHome
   *
   * @Route("/availableHome")
   * @Method({"GET"})
   *
